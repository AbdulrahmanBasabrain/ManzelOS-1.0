...
namespace ManzelOS_business_layer
{
    public class clsEmployee
    {
        ...
        public EmployeeDTO employeeDTO { get { return new EmployeeDTO(this.EmployeeId, this.PersonId, this.Salary, this.Job, this.OrganizationEmail, this.CreatedAt); }  }
        ...
        public clsEmployee(EmployeeDTO employeeDTO, enMode mode = enMode.enAddNewEmployee)
        {
            ...
            Job = employeeDTO.Job;
            OrganizationEmail = employeeDTO.OrganizationEmail;
