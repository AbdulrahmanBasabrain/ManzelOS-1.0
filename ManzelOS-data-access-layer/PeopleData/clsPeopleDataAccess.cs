    ...
    public class PeopleDTO
        {
            ...
            string email, string phone, string personalImagePath, short marriageStatusId, DateTime createdAt)
            {
...
(@firstName, @fatherName, @grandFatherName, @lastName, @nationalId, @dateOfBirth, @gender, @countryId, @cityId, @addressDistrict, @email, @phone, @personalImagePath, @marriageStatusId, @createdAt)
